...
import {resolutions} from '../utils/stubs';
import Pagination from '../reusable/Pagination';
import Document from '../components/Document/Document';

const Resolutions = () => {
    const pageName = 'Постановления Правительства Российской Федерации';
            ...
            <div className='content'>
                ...
                <div className='contacts'>
                    ...
                    <div className='column-content'>
                        {
                            resolutions && resolutions.map((document, i) => <Document key={i} {...document}/>)
                        }
                    </div>
                    <Pagination/>
                </div>
...
Resolutions.getInitialProps = async ({ ctx: { store } }) => {
