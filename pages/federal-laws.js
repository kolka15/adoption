...
import {federalLaws} from '../utils/stubs';
import Pagination from '../reusable/Pagination';
import Document from '../components/Document/Document';

const FederalLaws = () => {
    const pageName = 'Федеральные законы';
            ...
            <div className='content'>
                ...
                <div className='contacts'>
                    ...
                    <div className='column-content'>
                        {
                            federalLaws && federalLaws.map((document, i) => <Document key={i} {...document}/>)
                        }
                    </div>
                    <Pagination/>
                </div>
