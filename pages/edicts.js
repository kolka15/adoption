...
import {edicts} from '../utils/stubs';
import Pagination from '../reusable/Pagination';
import Document from '../components/Document/Document';

const Edicts = () => {
    const pageName = 'Указы Президента Российской Федерации';
            ...
            <div className='content'>
                ...
                <div className='contacts'>
                    ...
                    <div className='column-content'>
                        {
                            edicts && edicts.map((document, i) => <Document key={i} {...document}/>)
                        }
                    </div>
                    <Pagination/>
                </div>
...
Edicts.getInitialProps = async ({ ctx: { store } }) => {
